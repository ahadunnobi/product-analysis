...
const Header = () => {
  ...
  <div  className="sm:hidden" id="mobile-menu">
    ...
    <Link to={'/review'}><a href="reviwe"  className=" text-white block px-3 py-2 rounded-md text-base font-medium" aria-current="page">REVIEWS</a></Link>

    <Link to={'/dashboard'}><a href="/dashboard"  className="text-white block px-3 py-2 rounded-md text-base font-medium" aria-current="page">DASHBOARD</a></Link>
